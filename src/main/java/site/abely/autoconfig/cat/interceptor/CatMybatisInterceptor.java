 ...
 * 检测sql耗时
 * <p>
 * 代码来自于 https://github.com/dianping/cat/blob/master/integration/mybatis/interceptor/CatMybatisInterceptor.java
 *
 * @author abely
 */
...
public class CatMybatisInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        Transaction t = Cat.newTransaction(CustomCatConstants.SQL, methodName);
